 <?php
    ...
    if(isset($_POST['enviar'])) { // comprobamos que se hayan enviado los datos del formulario
        ...
        if(empty($_POST['usuario_nombre']) || empty($_POST['usuario_clave'])) {
            ...
            $sql = mysql_query("SELECT usuario_id, usuario_nombre, usuario_clave FROM proEvoTechTransac.AclUsuarios WHERE usuario_nombre='".$usuario_nombre."' AND usuario_clave='".$usuario_clave."'");
