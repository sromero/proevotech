<?php
    include('acceso_Db/acceso_db.php'); // incluímos los datos de acceso a la BD
?>
<!doctype html>
<html lang="en">
<head>
    ...
    <?php
        if(isset($_POST['enviar'])) { // comprobamos que se han enviado los datos del formulario
            if(empty($_POST['usuario_nombre'])) {
                ...
                $sql = mysql_query("SELECT usuario_nombre, usuario_clave, usuario_email FROM proEvoTechTransac.AclUsuarios WHERE usuario_nombre='".$usuario_nombre."'");
                if(mysql_num_rows($sql)) {
                    ...
                    mysql_query("UPDATE AclUsuarios SET usuario_clave='".$usuario_clave2."' WHERE usuario_nombre='".$usuario_nombre."'");
